...
CSV_FIELDS = [
    ...
    "latency_s_per_input_megapixel",
    "latency_s_per_output_megapixel",
    ...
    "latency_app_s_per_input_megapixel",
    "latency_app_s_per_output_megapixel",
    ...
    "container_attributed_j_per_input_megapixel",
    "container_attributed_j_per_output_megapixel",
